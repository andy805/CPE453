...
static void rr2_admit(thread new) {
...
static void rr2_remove(thread victim) {
...
static struct scheduler rr2_publish =
 {init, shutdown, rr2_admit,rr2_remove,rr2_next};
scheduler AltRoundRobin = &rr2_publish;
